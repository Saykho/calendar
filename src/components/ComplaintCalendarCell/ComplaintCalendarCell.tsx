  ...
  if (isHideMode) {
    return (
      <Flex
        ...
        align="center"
        className={`${styles.hiddenComplaints} hidden-complaints`}
      >
        <div className={styles.complaintsLength}>
          {complaintsForDate.length}{" "}
          <span className={`${styles.text} text`}>жалоб</span>
        </div>
        <RiseOutlined
          className={`${styles.showAll} show-icon`}
          onClick={() => {
            setIsHideMode(false);
          }}
        />
